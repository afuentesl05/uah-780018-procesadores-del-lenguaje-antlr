...
public class mueble_gramaticaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"MUEBLE", "HERRAMIENTA", "HERRAJE", "PIEZA", "CANTIDAD", "PASO", "USAR", 
			"UNIR", "FIJAR", "INSERTAR", "REPETIR", "DESHACER", "COMPROBAR", "ATORNILLAR", 
			"MARTILLAR", "COLGAR", "MARCAR", "PEGAR", "COLOCAR", "NIVELAR", "FIN", 
			"CON", "EN", "A", "Y", "USANDO", "PARED", "NUM", "CADENA", "ID", "COMA", 
			"PUNTOYCOMA", "DOS_PUNTOS", "ESPACIO"
		};
	}
	...
	public mueble_gramaticaLexer(CharStream input) {
		super(input);
